...
<div class="sl-mainpanel">
    ...
    <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
            ...
            <form method="POST" action="{{ route('emergency-contacts.store') }}" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row mg-b-25">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="location" value="{{ old('location') }}" id="location">
                                @error('location')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
